    ...
    function submitForm(id) {
      $("#" + id + " .jform").validate({
        submitHandler: function (form, event) {
          ...
          //gtag_signup_conversion();
          let srce = location.host.slice(0, 4);
          if (srce === "www.") {
            var loc = location.host.slice(4, location.host.length);
          } else {
            var loc = location.host;
          }
  
          let formitem = form.parentNode.id;
          $.ajax({
            type: "POST",
            enctype: "multipart/form-data",
            url: portal + "/portal/api/signIn.php",
            data: $("#" + formitem + " form").serialize(),
            dataType: "json",
            error: function () {
            ...
            success: function (response) {
              let cName = $("#" + id + ' .jform [name="cn"]').val();
              let direction = $("#" + id + ' .jform [name="direction"]').val();
